...
export default function FAQ(props) {
                ...
                <AccordionItem uuid={obj.index} className="flex justify-center flex-col border-b-2 border-topic_dark w-full">
                    <AccordionItemHeading className="flex justify-center w-full">
                        <AccordionItemButton className="flex justify-center m-auto flex-row w-full py-2 my-2 focus:outline-none">
                            ...
                            <div className="flex w-10/12 justify-center align-middle">
                                <text className="sm:text-md md:text-2xl text-text_light font-primary">{obj.question}</text>
                            </div>
                    ...
                    <AccordionItemPanel className="bg-topic_dark border-b-none">
                        <div className="flex justify-center m-auto flex-row w-full py-2 my-2 bg-topic_dark">
                            <text className="sm:text-md md:text-xl text-text_light font-primary">{obj.answer}</text>
                        </div>
                    </AccordionItemPanel>
                </AccordionItem>
            </ScrollAnimation>
    ...
    return (
        <div ref={props.faqRef} className="flex w-full h-landingHeight mx-app flex-col pt-12">
            <ScrollAnimation animateIn="fadeInTop" className="flex justify-center items-center flex-col w-full h-40 m-auto">
                <div className="flex justify-center items-center m-auto">
                    <text className="text-6xl lg:text-7xl text-center text-text_dark font-primary">FAQ</text>
                </div>
            </ScrollAnimation>
            <ScrollAnimation animateIn="fadeIn" className="flex lg:w-faq w-full mt-0 mx-auto mb-auto items-center justify-center flex-col my-20">
