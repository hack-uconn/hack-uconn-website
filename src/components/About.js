...
export default function About(props) {
    ...
    return (
        <div ref={props.aboutRef} id="about" className="flex w-full h-landingHeight m-auto items-center justify-center flex-col">
            <ScrollAnimation animateIn="fadeInLeft" animateOnce={true} className="flex justify-center items-center flex-col w-full h-full">
                ...
                <div className="flex justify-center items-center w-5/6 md:w-3/4 lg:w-aboutDescriptionWidth m-auto">
            ...
            <ScrollAnimation animateIn="fadeInUpBig" animateOnce={true} className="flex flex-col justify-center items-center w-full h-96 lg:h-96 m-auto bg-topic_about_slider shadow-2xl border-t-8 border-b-8 border-black">
