                    ...
                    <div className="flex flex-col w-full lg:w-auto m-auto">
                        <ScrollAnimation animateIn="slideInDown" className="flex flex-col justify-center mx-auto">
                            <div className="flex justify-center mb-4 md:mb-0">
                                <text className="text-3xl text-text_dark text-center font-primary">Lead Sponsors</text>
                            </div>
                        </ScrollAnimation>
                        <div className="flex flex-col justify-center h-80 md:h-auto w-full md:w-1/2 lg:w-sponsorTop md:mx-auto py-6 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                        ...
                        <ScrollAnimation animateIn="slideInLeft" className="flex flex-col justify-center mx-auto">
                            <div className="flex justify-center mb-4 md:mb-0">
                                <text className="text-3xl text-text_dark text-center font-primary">Gold Sponsors</text>
                            </div>
                        </ScrollAnimation>
                        <div className="flex flex-col justify-center h-80 md:h-auto w-full md:w-3/4 lg:w-sponsorMiddle md:mx-auto py-6 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                        ...
                        <ScrollAnimation animateIn="slideInRight" className="flex flex-col justify-center mx-auto">
                            <div className="flex justify-center mb-4 md:mb-0">
                                <text className="text-3xl text-text_dark text-center font-primary">Silver Sponsors</text>
                            </div>
                        </ScrollAnimation>
                        <div className="flex flex-col justify-center h-80 md:h-auto w-full md:w-full lg:w-sponsorBottom md:mx-auto py-6 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
